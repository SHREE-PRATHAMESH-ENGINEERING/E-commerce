    ...
    <>
      <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-lg font-semibold bg-[#f5772b] text-white border border-1 border-black py-2 rounded-full w-16 mx-auto">404</p>
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6 max-[350px]:flex-col max-[350px]:gap-y-5">
            <Link
              href="/"
              className="rounded-md bg-[#f5772b]  border border-1 border-black px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:text-[#f5772b] hover:bg-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              Go back home
            </Link>
