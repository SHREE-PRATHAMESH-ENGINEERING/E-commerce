...
const DashboardSidebar = () => {
  return (
    <div className="xl:w-[400px] bg-[#f5772b] h-full max-xl:w-full">
      <Link href="/admin">
        <div className="flex gap-x-2 w-full hover:bg-[#e6652a] cursor-pointer items-center py-6 pl-5 text-xl text-white">
