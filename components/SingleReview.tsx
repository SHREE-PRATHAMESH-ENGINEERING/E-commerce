...
const SingleReview = () => {
  return (
    <article className="w-[900px] mx-auto py-10 max-[1000px]:w-[700px] max-[750px]:w-[90%]">
      ...
      <a
        href="#"
        className="block mb-5 text-sm font-medium text-[#f5772b] hover:underline dark:text-[#f5772b]"
      >
        Read more
      </a>
      <aside>
        ...
        <div className="flex items-center mt-3">
          <a
            href="#"
            className="px-2 py-1.5 text-xs font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-[#f5772b] focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
          >
            Helpful
          </a>
          <a
            href="#"
            className="ps-4 text-sm font-medium text-[#f5772b] hover:underline dark:text-[#f5772b] border-gray-200 ms-4 border-s md:mb-0 dark:border-gray-600"
          >
            Report abuse
          </a>
        </div>
